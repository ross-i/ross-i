...
if __name__ == "__main__":
    ...
    nn.train(X_train,y_train,epochs=20,validation_data=(X_valid,y_valid),
             savebest=True,filepath='savedmodels/hcan_icd10.ckpt')
    
    #load best nn and test
    nn.load('savedmodels/hcan_icd10.ckpt')
